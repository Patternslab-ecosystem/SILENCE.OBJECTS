...
## 2026-02-08 — Docs sync with DIPLO_BIBLE v3

- Wszystkie 13 plików .md zsynchronizowane z DIPLO_BIBLE v3.0.
- Visual overhaul: SILENCE DARK design system.
- Safety hardening: output scan, circuit breaker, deterministic core, rate limiting.
